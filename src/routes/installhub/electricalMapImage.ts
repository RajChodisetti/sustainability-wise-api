...
const GRID_MARKER_HEIGHT = 150;
const BOARD_MARKER_WIDTH = 190;
const BOARD_MARKER_BASE_HEIGHT = 144;
const ASSET_MARKER_WIDTH = 164;
const ASSET_MARKER_HEIGHT = 150;
const RESIDUAL_MARKER_WIDTH = 160;
const RESIDUAL_MARKER_HEIGHT = 134;
const GRID_MEDALLION_RADIUS = 48;
const BOARD_MEDALLION_RADIUS = 39;
const ASSET_MEDALLION_RADIUS = 31;
const RESIDUAL_MEDALLION_RADIUS = 29;
